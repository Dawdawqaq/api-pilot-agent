 ...
 * 场景执行步骤审计数据库实体。
 */
@TableName("api_execution_step")
public class ExecutionStepAuditEntity {
    ...
    private String extractedNamesJson;
    ...
    public String getExtractedNamesJson() { return extractedNamesJson; }
    public void setExtractedNamesJson(String extractedNamesJson) {
        this.extractedNamesJson = extractedNamesJson;
    }
